...
// Function to clear the container and create new content
function clearAndCreateNewContent() {
  ...
  // Call the newContent function to add new content
  newContent();
}

// Function to add new content related to nutrition and well-being
function newContent() {
  //
  ...
  headingNav.textContent = "Nutrition and WellBeing";
  ...
  img1.src = "assets/coffee-cup.png";
  ...
  img2.src = "assets/nutrition-img2.jpg";
  ...
  // Additional div (not used in the code you provided)
